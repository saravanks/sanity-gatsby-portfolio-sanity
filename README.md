# sanity-gatsby-portfolio-sanity
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/q4tf9w0g/settings/api) and create a token with read rights.
